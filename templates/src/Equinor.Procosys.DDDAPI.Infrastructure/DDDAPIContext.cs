...
{
    public class DDDAPIContext : DbContext, IUnitOfWork, IReadOnlyContext
    {
        private readonly IEventDispatcher _eventDispatcher;
        private readonly IPlantProvider _plantProvider;

        public DDDAPIContext(
            DbContextOptions<DDDAPIContext> options,
        ...
        private void SetGlobalPlantFilter(ModelBuilder modelBuilder)
        {
            ...
            {
                typeof(DDDAPIContext)
                .GetMethod(nameof(DDDAPIContext.SetGlobalQueryFilter))
